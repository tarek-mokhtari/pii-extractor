...
const dateTextRe = /\b\d{1,2}\s+(janvier|février|mars|avril|mai|juin|juillet|août|septembre|octobre|novembre|décembre)(\s+\d{4})?\b/gi;
...
function maskPII(text) {
  return text
    ...
    .replace(dateTextRe, '[date protégée]');
}
